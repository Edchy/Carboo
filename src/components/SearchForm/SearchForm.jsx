  ...
  return (
    <form className="search-form" onSubmit={onSubmit}>
      ...
      <div className="form-buttons">
        ...
        {/* InfoCircle tar emot en komponent(med props) som prop. Tyckte detta var rätt coolt att det gick att göra. Men när jag tänker på det så är ju en komponent bara en js-funktion, så it makes sense.
         Blir inte helt lättläsligt. Men jag ville att man ska kunna skriva in en textsträng som children-prop då detta ska vara en återanvändbar komponent där man lätt kan fylla på med vad man vill ha i den som children.*/}
        <InfoCircle
          offset={-24}
          boxdirecion="right"
          component={
        ...
        >
          ...
          <p>
            ...
            check the results from a reliable resource like for example the U.S.
